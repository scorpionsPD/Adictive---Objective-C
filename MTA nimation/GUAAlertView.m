...
- (void)setupAlertView {
    ...
    _alertView.backgroundColor = [UIColor colorWithRed:208.0/255.0 green:156/255.0 blue:40/255.0 alpha:1.0];
...
- (void)setupButton {
    ...
    // gray seperator
    _button.backgroundColor =[UIColor colorWithRed:208.0/255.0 green:156/255.0 blue:40/255.0 alpha:1.0];
    ...
    [_button setBackgroundImage:imageFromColor([UIColor colorWithRed:29/255.0 green:12/255.0 blue:9/255.0 alpha:1.0])
